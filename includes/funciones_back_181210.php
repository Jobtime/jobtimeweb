...
if($sql_post == "")
	$sql = "SELECT * FROM empleos, ciudades, empresas WHERE empleos.ciudad = ciudades.numero_ciudad AND empresas.id_empresa = empleos.id_empresa  order by empleos.tipo asc, empleos.activo desc, empleos.publicacion desc";
else
