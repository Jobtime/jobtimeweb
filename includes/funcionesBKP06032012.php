...
while($congresos = mysql_fetch_array($resul_congresos))
	if($congresos['curso'] != "")
		$congre = $congre.$congresos['curso']." <br /><br /> ";
...
function editar_curso($dni)
{
	...
	if($num_rows == 0)
			echo "<p style='color:red;'><strong>ATENCI&Oacute;N:</strong> No posee cursos cargados!!!</p>";
	else
	{
...
function editar_idioma($dni)
{
	...
	if($num_rows == 0)
			echo "<p style='color:red;'><strong>ATENCI&Oacute;N:</strong> No posee idiomas cargados!!!</p>";
	else
	{
